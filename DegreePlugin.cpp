...
#include "DegreePlugin.h"

void DegreePlugin::input(std::string file) {
...
void DegreePlugin::output(std::string file) {
...
PluginProxy<DegreePlugin> DegreePluginProxy = PluginProxy<DegreePlugin>("Degree", PluginManager::getInstance());
